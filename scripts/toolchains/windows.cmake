if(NOT _VCPKG_WINDOWS_TOOLCHAIN)
    ...
    set(CMAKE_CXX_FLAGS " /nologo /DWIN32 /D_WINDOWS /DWINVER=0x0A00 /D_WIN32_WINNT=0x0A00 /Gy /FS /bigobj /utf-8 /Zc:sizedDealloc- /MP /EHsc /GR ${VCPKG_CXX_FLAGS}" CACHE STRING "")
    set(CMAKE_C_FLAGS " /nologo /DWIN32 /D_WINDOWS /DWINVER=0x0A00 /D_WIN32_WINNT=0x0A00 /Gy /FS /bigobj /utf-8 /Zc:sizedDealloc- /MP ${VCPKG_C_FLAGS}" CACHE STRING "")
    ...
    set(CMAKE_CXX_FLAGS_RELEASE "${VCPKG_CRT_LINK_FLAG_PREFIX} /O2 /Oy- /Zc:inline /Gw /Oi /guard:cf ${VCPKG_CXX_FLAGS_RELEASE}" CACHE STRING "")
    set(CMAKE_C_FLAGS_RELEASE "${VCPKG_CRT_LINK_FLAG_PREFIX} /O2 /Oy- /Zc:inline /Gw /Oi /guard:cf ${VCPKG_C_FLAGS_RELEASE}" CACHE STRING "")

    string(APPEND CMAKE_STATIC_LINKER_FLAGS_RELEASE_INIT " /nologo ")
    set(CMAKE_MODULE_LINKER_FLAGS_RELEASE "/nologo /DEBUG /INCREMENTAL:NO /FIXED:NO /OPT:REF /OPT:ICF /NXCOMPAT /DYNAMICBASE /GUARD:CF /CETCOMPAT ${VCPKG_LINKER_FLAGS} ${VCPKG_LINKER_FLAGS_RELEASE}" CACHE STRING "")
    set(CMAKE_SHARED_LINKER_FLAGS_RELEASE "/nologo /DEBUG /INCREMENTAL:NO /FIXED:NO /OPT:REF /OPT:ICF /NXCOMPAT /DYNAMICBASE /GUARD:CF /CETCOMPAT ${VCPKG_LINKER_FLAGS} ${VCPKG_LINKER_FLAGS_RELEASE}" CACHE STRING "")
    set(CMAKE_EXE_LINKER_FLAGS_RELEASE "/nologo /DEBUG /INCREMENTAL:NO /FIXED:NO /OPT:REF /OPT:ICF /NXCOMPAT /DYNAMICBASE /GUARD:CF /CETCOMPAT ${VCPKG_LINKER_FLAGS} ${VCPKG_LINKER_FLAGS_RELEASE}" CACHE STRING "")
